...
install.packages("tseries")                  #Instala pacote tseries
install.packages(readxl)                     #Instala pacote readxl
install.packages("pwt8")                     #Instala pacote pwt8
library(forecast)                            #Carrega o pacote forecast
library(tseries)                             #Carrega o pacote tseries
library("urca")                              #Carrega o pacote urca
library(readxl)                              #Carrega o pacote readxl
library(pwt8)                                #Carrega o pacote pwt8
...
TesteADF_PIB_drift <- ur.df(pib, "drift", lags = 1)         #Teste DF-DickFuller com drift e com tendencia
...
DIFERENCAPIB <- ts(diferenca1PIB, start = 1994, frequency = 1)   #Define série temporal para a tabela diferenca1
